...
\begin{document}
	...
	\section{Information-Theoretic Path Planning}
		...
		\subsection{Description of Entropy and Mutual Entropy}
			...
			\begin{align}
				\nonumber p\left(\textbf{c}\right) = 0 \; &: \; H \left(\textbf{c}\right) = -(1)ln(1)-0ln(0) = 0 \\
				\nonumber p\left(\textbf{c}\right) = 0.5 \; &: \; H \left(\textbf{c}\right) = -(0.5)ln(0.5)-0.5ln(0.5) = ln2 \\
				\nonumber p\left(\textbf{c}\right) = 1 \; &: \; H \left(\textbf{c}\right) = -(0)ln(0)-1ln(1) = 0 \\
			\end{align}
