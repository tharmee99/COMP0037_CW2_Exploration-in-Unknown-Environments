...
\begin{document}
	...
	\section{Reactive Planner }
		...
		\subsection{Improving the performance of the Reactive Planner}
			\begin{itemize}
				\item Better global planner
				\item Remedial action to overcome obstacle
				\item Locally plan around obstacle
				\item Globally replan the path (using better planning algorithm)
			\end{itemize}
